class Flax extends THREE.Group {
    ...
    //material
    var hallMaterials = [
        new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("textures/tree/flax.png"), side: THREE.BackSide, opacity: params.opacity,transparent: true }), //LEFT
        new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("textures/tree/flax.png"), side: THREE.BackSide, opacity: params.opacity,transparent: true  }), //RIGHT
        ...
        new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("textures/tree/flax.png"), side: THREE.BackSide, opacity: params.opacity,transparent: true  }), //FRONT
        new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("textures/tree/flax.png"), side: THREE.BackSide, opacity: params.opacity,transparent: true  }), //BACK
        ];
